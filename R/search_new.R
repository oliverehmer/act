...
#' @param resultidPrefix Character string; search results will be numbered consecutively; This character string will be placed before the consecutive numbers.
#' @param resultidStart Integer; search results will be numbered consecutively; This is the start number of the identifiers.
...
#' @param filterTierNames Vector of character strings; names of tiers to be included in the search. 
...
search_new <- function(x, 
	...
	if (1==2) {
		x                            <- corpus
		pattern                      <- '.+' 
		pattern         		     <-'(238_007|237_004|204_043|238_002|211_004|207_025|237_015|210_004).*'
		searchMode                   <-  "content" ##c("content", "fulltext", "fulltext.byTime", "fulltext.byTier")
	...
	s@resultid.prefix            	<- resultidPrefix
	s@resultid.start            	<- resultidStart
